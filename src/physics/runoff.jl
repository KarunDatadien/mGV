...
#    total_water_input_veg = i_0 .+ throughfall[:, :, :, 1:end-1]
#    runoff_veg = ifelse.(total_water_input_veg .>= i_m,
#                         # Eq. 18a: Saturated case
#                         throughfall[:, :, :, 1:end-1] .- topsoil_moisture_max .+ topsoil_moisture,
#                         # Eq. 18b: Unsaturated case
#                         throughfall[:, :, :, 1:end-1] .- topsoil_moisture_max .+ topsoil_moisture .+
...
#    runoff_bare = ifelse.(total_water_input_bare .>= i_m,
#                          # Eq. 18a: Saturated case
#                          prec_gpu[:, :, :, end:end] .- topsoil_moisture_max .+ topsoil_moisture,
#                          # Eq. 18b: Unsaturated case
#                          prec_gpu[:, :, :, end:end] .- topsoil_moisture_max .+ topsoil_moisture .+
#                          topsoil_moisture_max .* (1.0 .- total_water_input_bare ./ i_m) .^ (1.0 .+ b_i))
#
